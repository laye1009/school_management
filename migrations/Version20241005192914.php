 ...
 */
final class Version20241005192914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT NOT NULL, student_id INT DEFAULT NULL, matiere_id INT DEFAULT NULL, note INT NOT NULL, type VARCHAR(255) NOT NULL, appreciation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE note ADD CONSTRAINT FK_CFBDFA14CB944F1A FOREIGN KEY (student_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
